...
def send_certificate_email(email, certificate_path):
    ...
    smtp_username = "gautamsamblani3@gmail.com"  # Your email address
    smtp_password = "gautamaspire5332@samblani"  # Your email password

    subject = "Certificate Attached"
    sender_email = "gautamsamblani3@gmail.com" # Your email address
